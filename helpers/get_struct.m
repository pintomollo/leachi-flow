  ...
  switch type
    ...
    case 'MicroMos'
      mystruct = struct('ImageFolder', '', ... % absolute or relative path where the images are stored inside the computer.
                        ...
                        'flag_ShowROIsingleImages', 0, ... % to show inside the final mosaic the Region Of Interest of the single images. 0 = not active. 1 = active.
                        'flag_SlideShow', 0, ... % to save an image of the current mosaic every time an image is stitched. 0 = not active. 1 = active.
                        'flag_ComputeMetrics', 0, ... % to assess the quality of the output mosaic using standard metrics computed only in the overlapping regions. 0 = not active. 1 = active.
