function [H, inliers] = RansacAffine(x1, x2, t)
...
s = 3; % Minimum No of points needed to fit a affine. 
...
% be inliers.
H = AffineModel2D(x1(:,inliers), x2(:,inliers));
...
function Ha = AffineModel2D(varargin)
