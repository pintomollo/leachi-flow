function [newunregistered, regionOverlapped] = ImagesForFTM2(Mosaic, unregistered, GLOBAL, MosaicOrigin, InterpolationMode, RegistrationMode)
...
regionOverlapped    = Mosaic(ULCrc(1):DRCrc(1), ULCrc(2):DRCrc(2), :);
