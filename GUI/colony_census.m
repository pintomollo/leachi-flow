...
% 14.05.2014
  ...
  if (~was_tracking || data.is_updated)
  ...
  % to exit it
    ...
    if (handles.current > 0)
      data.channels(handles.current).pixel_size = get(handles.resolution, 'Data');
      data.channels(handles.current).amplitude = get(handles.amplitude, 'Data');
    end
